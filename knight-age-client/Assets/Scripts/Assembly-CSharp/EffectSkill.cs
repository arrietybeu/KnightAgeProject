		...
		try
		{
			...
			case 124:
				...
				if (y + vy > yto)
				{
					...
					for (int num11 = 0; num11 < num10; num11++)
					{
						int num12 = 24 * posx[indexpost][num11] + CRes.random(10, 100);
						int num13 = 24 * posy[indexpost][num11] + CRes.random(10, 100);
						GameScreen.addEffectEndKill(36, num12, num13);
						GameScreen.addEffectEndKill(9, num12, num13);
					}
				}
				break;
			case 0:
			...
			case 114:
			{
				...
				{
					Point point30 = (Point)VecEff.elementAt(num43);
					if (f == point30.f)
					{
						if (typeEffect == 11)
						{
				...
				{
					Point point32 = (Point)VecSubEff.elementAt(num44);
					point32.f++;
			...
			case 115:
			{
				for (int num41 = 0; num41 < VecEff.size(); num41++)
				{
					Point point28 = (Point)VecEff.elementAt(num41);
					if (point28.f == 0)
					{
						flag2 = false;
						if (f >= fRemove)
			...
			case 26:
			{
				for (int num71 = 0; num71 < VecEff.size(); num71++)
				{
					Point point54 = (Point)VecEff.elementAt(num71);
					point54.f++;
					if (point54.f >= 7)
					{
			...
			case 27:
			{
				...
				{
					Point point11 = (Point)VecEff.elementAt(num9);
					point11.f++;
					if (point11.f >= 3)
					{
			...
			case 23:
			{
				...
				{
					Point point48 = (Point)VecEff.elementAt(num63);
					point48.update();
				...
				if (f == 0)
				{
					...
					GameScreen.addEffectEndKill(13, num64, num65);
				}
				break;
			}
			case 25:
			{
				...
				{
					Point point25 = (Point)VecEff.elementAt(num37);
					point25.f++;
					if (point25.f > 3)
					{
			...
			case 84:
			{
				for (int num62 = 0; num62 < VecEff.size(); num62++)
				{
					Line line5 = (Line)VecEff.elementAt(num62);
					line5.update();
					if (f >= fRemove && test == 0)
					{
			...
			case 34:
			{
				for (int num68 = 0; num68 < VecEff.size(); num68++)
				{
					Point point50 = (Point)VecEff.elementAt(num68);
					point50.update();
					if (point50.f >= 3)
					{
			...
			case 40:
			{
				if (f <= 4)
				{
					if (objBeKillMain != null && (toX != objBeKillMain.x || toY != objBeKillMain.y - objBeKillMain.hOne / 2) && objBeKillMain.Action != 4)
					{
						for (int num46 = 0; num46 < VecEff.size(); num46++)
						{
							Point point34 = (Point)VecEff.elementAt(num46);
							toX = objBeKillMain.x;
							toY = objBeKillMain.y - objBeKillMain.hOne / 2;
							point34.x = toX * 1000;
							point34.y = toY * 1000;
				...
				else
				{
					for (int num47 = 0; num47 < VecEff.size(); num47++)
					{
						Point point35 = (Point)VecEff.elementAt(num47);
						if (f % 3 == 0)
						{
							point35.vx /= 2;
							point35.vy /= 2;
				...
				{
					Point point36 = (Point)VecSubEff.elementAt(num48);
					point36.update();
					if (f > 16)
					{
			...
			case 42:
			{
				...
				for (int num42 = 0; num42 < VecEff.size(); num42++)
				{
					Point point29 = (Point)VecEff.elementAt(num42);
					if (CRes.random(3) == 0)
					{
						if (point29.fRe == 1)
						{
			...
			case 126:
			{
				...
				{
					removeEff();
					for (int num14 = 0; num14 < vecObjBeKill.size(); num14++)
					{
						Object_Effect_Skill object_Effect_Skill2 = (Object_Effect_Skill)vecObjBeKill.elementAt(num14);
						if (object_Effect_Skill2 != null)
						{
				...
				int num16 = 320;
				if (num16 < GameCanvas.h)
				{
					num16 = GameCanvas.h;
				}
				if (num16 < GameCanvas.w)
				{
					num16 = GameCanvas.w;
				}
				if (angle > 60 && angle < 120)
				{
					R = y + CRes.sin(60) * num16 / 1000;
				}
				else
				{
					R = x + CRes.cos(0) * num16 / 1000;
				}
				for (int num17 = 0; num17 < VecEff.size(); num17++)
				{
					Point point14 = (Point)VecEff.elementAt(num17);
					point14.f++;
					if (point14.f >= 4)
					{
			...
			case 106:
			{
				...
				int num73 = 320;
				if (num73 < GameCanvas.h)
				{
					num73 = GameCanvas.h;
				}
				if (num73 < GameCanvas.w)
				{
					num73 = GameCanvas.w;
				}
				if (angle > 60 && angle < 120)
				{
					R = y + CRes.sin(60) * num73 / 1000;
				}
				else
				{
					R = x + CRes.cos(0) * num73 / 1000;
				}
				for (int num74 = 0; num74 < VecEff.size(); num74++)
				{
					Point point57 = (Point)VecEff.elementAt(num74);
					point57.f++;
					if (point57.f >= 4)
					{
			...
			case 105:
			{
				...
				if (f < fRemove)
				{
					if (f == 8)
					{
						...
						if (objBeKillMain != null && objKill != null)
						{
							...
							int num34 = 320;
							if (num34 < GameCanvas.h)
							{
								num34 = GameCanvas.h;
							}
							if (num34 < GameCanvas.w)
							{
								num34 = GameCanvas.w;
							}
							x1000 = x + CRes.cos(a2) * num34 / 1000;
							y1000 = y + CRes.sin(a2) * num34 / 1000;
							toX = objBeKillMain.x;
							toY = objBeKillMain.y - objBeKillMain.hOne / 2;
						}
					}
				...
				for (int num35 = 0; num35 < VecEff.size(); num35++)
				{
					Point point22 = (Point)VecEff.elementAt(num35);
					point22.f++;
					if (point22.f >= 4)
					{
			...
			case 54:
			{
				...
				for (int num61 = 0; num61 < VecEff.size(); num61++)
				{
					Point point47 = (Point)VecEff.elementAt(num61);
					point47.f++;
					if (point47.f / 2 >= 4)
					{
			...
			case 55:
			{
				for (int num26 = 0; num26 < VecEff.size(); num26++)
				{
					Line line3 = (Line)VecEff.elementAt(num26);
					line3.update();
				...
				if (objBeKillMain != null && !objBeKillMain.isRemove && !objBeKillMain.isStop && objBeKillMain.Action != 4)
				{
					toX = objBeKillMain.x;
					toY = objBeKillMain.y - objBeKillMain.hOne / 2;
					num27 = objBeKillMain.hOne / 2;
				}
				int num28 = CRes.random(2, 4);
				for (int num29 = 0; num29 < num28; num29++)
				{
					int num30 = CRes.random(10, 24);
					int num31 = CRes.random_Am_0(15);
					int num32 = CRes.random_Am(6, 12);
					Line line4 = new Line();
					if (Direction == 2 || Direction == 3)
					{
						line4.x0 = toX + num31;
						line4.x1 = line4.x0 + ((num31 <= 0) ? (-num30) : num30);
						line4.y0 = (line4.y1 = toY + CRes.random_Am_0(num27 + 10));
						line4.vx = num32;
					}
					else
					{
						line4.y0 = toY + num31;
						line4.y1 = line4.y0 + ((num31 <= 0) ? (-num30) : num30);
						line4.x0 = (line4.x1 = toX + CRes.random_Am_0(num27 + 10));
						line4.vy = num32;
					}
			...
			case 70:
			{
				...
				{
					Line line6 = (Line)VecEff.elementAt(num75);
					line6.update();
					line6.update();
					line6.vx += line6.vx / 5;
					line6.vy += line6.vy / 5;
			...
			case 58:
			{
				if (f < fRemove)
				{
					if (f % 3 == 1)
					{
						int num38 = MainScreen.cameraMain.yCam + (y - MainScreen.cameraMain.yCam) % 30 - 30;
						for (int num39 = 0; num39 < 2; num39++)
						{
							Point point26 = new Point();
							point26.x = x;
							point26.y = num38 + num39 * 3;
							point26.vy = 30;
				...
				for (int num40 = 0; num40 < VecEff.size(); num40++)
				{
					Point point27 = (Point)VecEff.elementAt(num40);
					point27.update();
					if (point27.y > y)
					{
			...
			case 60:
				if (f == 0)
				{
					...
					{
						Point point23 = (Point)VecEff.elementAt(num36);
			...
			case 77:
			{
				for (int num53 = 0; num53 < VecEff.size(); num53++)
				{
					Point point39 = (Point)VecEff.elementAt(num53);
					for (int num54 = 0; num54 < point39.vecEffPoint.size(); num54++)
					{
						Point point40 = (Point)point39.vecEffPoint.elementAt(num54);
			...
			case 63:
			{
				for (int num49 = 0; num49 < VecEff.size(); num49++)
				{
					Point point37 = (Point)VecEff.elementAt(num49);
					point37.update();
				...
				if (f < fRemove)
				{
					...
					else
					{
						...
						if (f % 3 == 0)
						{
							GameScreen.addEffectEndKill(13, num50, num51);
						}
			...
			case 73:
			{
				...
				{
					Point point15 = (Point)VecSubEff.elementAt(num18);
					point15.f++;
					if (point15.f / 2 > 3)
					{
				...
				{
					Point point16 = (Point)VecEff.elementAt(num19);
					point16.update();
							...
							if (object_Effect_Skill3 != null)
							{
								...
								if (mainObject3 != null)
								{
									...
									else
									{
										...
										GameScreen.addEffectEndKill(13, num20, num21);
									}
								}
							}
							indexLan++;
			...
			case 74:
			{
				...
				{
					Point_Focus point_Focus = (Point_Focus)VecEff.elementAt(num69);
			...
			case 79:
				if (f == 0)
				{
					for (int num55 = 0; num55 < vecObjBeKill.size(); num55++)
					{
						Object_Effect_Skill object_Effect_Skill4 = (Object_Effect_Skill)vecObjBeKill.elementAt(num55);
						if (object_Effect_Skill4 == null)
						{
			...
			case 83:
			{
				...
				{
					Point point20 = (Point)VecEff.elementAt(num25);
					point20.f++;
					if (point20.f > 4)
					{
			...
			case 88:
			{
				...
				{
					Point point49 = (Point)VecEff.elementAt(num67);
					point49.f++;
					if (point49.f / 2 > 3)
					{
			...
			case 65:
			{
				for (int num66 = 0; num66 < vecObjBeKill.size(); num66++)
				{
					Object_Effect_Skill object_Effect_Skill5 = (Object_Effect_Skill)vecObjBeKill.elementAt(num66);
					MainObject mainObject4 = MainObject.get_Item_Object(object_Effect_Skill5.ID, object_Effect_Skill5.tem);
			...
			case 89:
			{
				...
				for (int num58 = 0; num58 < VecEff.size(); num58++)
				{
					Point point43 = (Point)VecEff.elementAt(num58);
					point43.f++;
					if (point43.f / 2 > 3)
					{
			...
			case 92:
			{
				...
				{
					Point point33 = (Point)VecEff.elementAt(num45);
					point33.f++;
					if (point33.f / 2 > 3)
					{
				...
				if (f < fRemove)
				{
					if (f == 8)
					{
						...
						if (objBeKillMain != null && objKill != null)
						{
							...
							int num23 = 320;
							if (num23 < GameCanvas.h)
							{
								num23 = GameCanvas.h;
							}
							if (num23 < GameCanvas.w)
							{
								num23 = GameCanvas.w;
							}
							x1000 = x + CRes.cos(a) * num23 / 1000;
							y1000 = y + CRes.sin(a) * num23 / 1000;
							toX = objBeKillMain.x;
							toY = objBeKillMain.y - objBeKillMain.hOne / 2;
